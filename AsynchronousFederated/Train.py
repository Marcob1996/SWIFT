...
def run(rank, size):
    ...
    api_key="e0KH5DKXEHaKgtPl79V78Yp5F",
    project_name="padfl-experiments",
    workspace="rabbanitw",
    )
    ...
    if rank == size-1:
        ...
        experiment.log_metric("Train Accuracy", top1.avg)
        experiment.log_metric("Test Accuracy", test_acc)
        experiment.log_metric("Validation Accuracy", val_acc)
        experiment.log_metric("Loss", losses)
        experiment.log_metric("Communication Time", comm_time)
